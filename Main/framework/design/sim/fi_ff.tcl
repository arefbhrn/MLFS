...
quietly set lstCells [lsearch -all -inline $lstObjects "*\(fd*\)*"];
quietly lappend lstCells {*}[lsearch -all -inline $lstObjects "*\(FD*\)*"];
...
for {set i 0} {$i < $faultInjectionIterations} {incr i} {
    ...
    for {set j 0} {$j < 100} {incr j} {
        ...
        echo "    FF   :   $cellSignal";
        # quietly set value [changeRandomBit "0" 0 1];
        quietly set value [changeRandomBit "0" [expr round(rand())] 1];
        echo "    Val1 :   $value";
